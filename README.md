...
FROM `arched-memory-483623-k2.dbt_prod.fct_monthly_zone_revenue_a`;
```


### Question 4:
 **Answer:** East Harlem North - 2053847.14
 ```
SELECT
    pickup_zone,
    SUM(revenue_monthly_total_amount) AS total_revenue_2020
FROM `arched-memory-483623-k2.dbt_prod.fct_monthly_zone_revenue`
 ...
 **Answer:** 384,624
 ...
 ```
 select
    sum(total_monthly_trips) as green_oct_2019_trips
from `arched-memory-483623-k2.dbt_prod.fct_monthly_zone_revenue_a`
where taxi_type = 'green'
